        ...
        <div className="md:flex block items-center text-white mb-14 md:mb-0">
          ...
          <div className="flex items-center md:w-6/12 w-full order-first">
            <div className="w-2/12">
              <a href="https://github.com/devina36" className="text-prl text-3xl font-semibold">
                <AiFillGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/devina-amalia-arindi/"
                className="text-prl text-3xl font-semibold"
              >
                <AiFillLinkedin />
              </a>
              <a href="https://www.instagram.com/dvnaa.lia/" className="text-prl text-3xl font-semibold">
                <AiFillInstagram />
              </a>
            </div>
            <div className="w-10/12">
              ...
              <h2 class="text-nama font-bold">I'm Devina Amalia!</h2>
              <p className=" text-lg font-normal leading-relaxed opacity-60">
                I am fresh graduate from State University of Malang, focus on web developer and frontend
                developer.
              </p>
              <Link
                to="/overview"
